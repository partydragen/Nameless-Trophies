                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <span class="float-md-right">
                                    ...
                                    <a onclick="showRewardModal()" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Reward Trophy</a>
                                </span>
                            </div>
                        </div>
                        <hr />
                                            ...
                                            <td>
                                                <div class="float-md-right">
                                                    <button class="btn btn-danger btn-sm" type="button"
                                                            onclick="showDeleteModal('{$trophy.rid}')">{$REMOVE}</button>
                                                </div>
                                            </td>
                                        </tr>
                                    {/foreach}
                    ...
                    <form action="" method="post" id="reward-trophy">
                        <div class="form-group">
                            ...
                            <select name="trophy" id="inputTrophy" class="form-control">
                                ...
                                {foreach from=$ALL_TROPHIES_LIST item=trophy}
